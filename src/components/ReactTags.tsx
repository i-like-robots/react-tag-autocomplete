...
const DefaultClassNames: ClassNames = {
  ...
  tagList: 'react-tags__selected',
  tagListItem: 'react-tags__selected-item',
  tag: 'react-tags__selected-tag',
  tagName: 'react-tags__selected-tag-name',
  comboBox: 'react-tags__search',
  comboBoxWrapper: 'react-tags__search-wrapper',
  comboBoxInput: 'react-tags__search-input',
  listBox: 'react-tags__suggestions',
  option: 'react-tags__suggestions-item',
