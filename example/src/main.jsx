...
import { CountrySelectorReactDnd } from './demos/CountrySelectorReactDnd'
import { CountrySelectorDndKit } from './demos/CountrySelectorDndKit'
...
window.onload = () => {
  ...
  container7.render(<CountrySelectorReactDnd />)

  const container8 = ReactDOM.createRoot(document.getElementById('demo-8'))
  container8.render(<CountrySelectorDndKit />)
}
